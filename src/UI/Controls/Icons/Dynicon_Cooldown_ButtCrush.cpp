...
namespace ImGuiEx {
	...
	DynIconCooldownButtCrush::DynIconCooldownButtCrush(uint32_t a_size) : IDynIcon(ImageList::CooldownIcon_ButtCrush, a_size) {
	...
	bool DynIconCooldownButtCrush::Draw(float a_percent, float a_totalCooldown, bool a_alwaysShow) const {
