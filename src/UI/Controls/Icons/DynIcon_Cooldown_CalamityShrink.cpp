...
namespace ImGuiEx {
	...
	DynIconCooldownCalamityShrink::DynIconCooldownCalamityShrink(uint32_t a_size) : IDynIcon(ImageList::CooldownIcon_TinyCalamity, a_size) {
	...
	bool DynIconCooldownCalamityShrink::Draw(float a_percent, float a_totalCooldown, bool a_alwaysShow) const {
		...
		{
			const float overflow = a_totalCooldown * 0.8f;
