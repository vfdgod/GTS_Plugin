...
namespace ImGuiEx {
	...
	DynIconCooldownHugAbsorb::DynIconCooldownHugAbsorb(uint32_t a_size) : IDynIcon(ImageList::CooldownIcon_HugAbsorb, a_size) {
	...
	bool DynIconCooldownHugAbsorb::Draw(float a_percent, float a_totalCooldown, bool a_alwaysShow) const {
